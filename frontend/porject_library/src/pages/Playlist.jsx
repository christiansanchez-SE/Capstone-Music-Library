...
function Playlist() {
  ...
  // This function will add the music to the favorited array
  ...
  return (
    <div className="playlist">
      ...
      <div className="playlist-main-container">
        {/* This will display all the music in the current database and/or the music that was searched in the search bar */}
        {filteredMusic.map((music, index) => (
          <div className="playlist-music-library" key={index}>
            ...
            <button onClick={() => handleAddToFavorites(music)}>
              Add to Favorites
            </button>
          </div>
        ))}
      ...
      <div className="playlist-favorites-container">
        ...
        {favorites.map((music, index) => (
          <div className="playlist-music-library" key={index}>
            ...
            />
            <p>Genre: {music.genre.join(", ")}</p>
            <button onClick={() => handleRemoveFromFavorites(music)}>
